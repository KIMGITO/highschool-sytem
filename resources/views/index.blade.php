    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li class="navbar-item">
            <a href={{ route('dashboard') }} class="navbar-link hover-underline">
              <div class="separator"></div>

              <span class="span">Staffs</span>
            </a>
          </li>
      ...
      <section class="hero text-center" aria-label="home" id="home">
        ...
        <ul class="hero-slider" data-hero-slider>
          ...
          <li class="slider-item active" data-hero-slider-item>
            ...
            <div class="slider-bg">
              <img src="./assets/images/school.jpg" width="1880" height="950" alt="" class="img-cover">
            </div>
      ...
      <section class="special-dish text-center" aria-labelledby="dish-label">
        ...
        <div class="special-dish-content bg-black-10">
          <div class="container">
            ...
            <p class="section-text">
               Lorem Ipsum is simply dummy text of the printingand typesetting industry lorem Ipsum has been the
              industrys standard dummy text ever since the when a Lorem Ipsum is simply dummy text of the printingand typesetting industry lorem Ipsum has been the
              industrys standard dummy text ever since the when a Lorem Ipsum is simply dummy text of the printingand typesetting industry lorem Ipsum has been the
              industrys standard dummy text ever since the when a Lorem Ipsum is simply dummy text of the printingand typesetting industry lorem Ipsum has been the
              industrys standard dummy text ever since the when a Lorem Ipsum is simply dummy text of the printingand typesetting industry lorem Ipsum has been the
              industrys standard dummy text ever since the when a
               Lorem Ipsum is simply dummy text of the printingand typesetting industry lorem Ipsum has been the
              industrys standard dummy text ever since the when a
               Lorem Ipsum is simply dummy text of the printingand typesetting industry lorem Ipsum has been the
              industrys standard dummy text ever since the when a
            ...
            <li>
              <div class="menu-card hover:card">
                ...
                <figure class="card-banner img-holder" style="--width: 100; --height: 100;">
                  <img src="./assets/images/school.png" width="100" height="100" loading="lazy" alt="Greek Salad"
                    class="img-cover">
                </figure>
